...
static void initStatechart(Dishwasher* const me) {
    ...
    me->on_lastState = Dishwasher_RiCNonState;
...
void Dishwasher_on_exit(Dishwasher* const me) {
    me->on_lastState = me->on_subState;
    switch (me->on_subState) {
        ...
        case Dishwasher_washing:
        {
            ...
            me->on_lastState = Dishwasher_washing;
        }
        break;
        /* State rinsing */
        case Dishwasher_rinsing:
        {
            ...
            me->on_lastState = Dishwasher_rinsing;
        }
        break;
        /* State drying */
        case Dishwasher_drying:
        {
            ...
            me->on_lastState = Dishwasher_drying;
        }
        break;
        default:
            break;
...
void Dishwasher_on_entHist(Dishwasher* const me) {
    if(me->on_lastState == Dishwasher_RiCNonState)
        ...
        {
            me->on_subState = me->on_lastState;
            switch (me->on_subState) {
                case Dishwasher_washing:
                {
                    NOTIFY_STATE_ENTERED(me, Dishwasher, "ROOT.Active.running.on.washing");
            ...
            switch (id) {
                ...
                case Null_id:
                {
                    ...
                    if(isInNeedOfService(me))
                        {
                            NOTIFY_NULL_TRANSITION_STARTED(me, Dishwasher, "15");
                            RiCReactive_popNullConfig(&(me->ric_reactive));
                            NOTIFY_STATE_EXITED(me, Dishwasher, "ROOT.Active.service.normal");
    ...
    switch (me->running_active) {
        ...
        case Dishwasher_off:
        {
            if(id == evStart_Default_id)
                {
                    NOTIFY_TRANSITION_STARTED(me, Dishwasher, "5");
                    NOTIFY_STATE_EXITED(me, Dishwasher, "ROOT.Active.running.off");
                    {
                        /*#[ transition 5 */
                        setup(me);
        ...
        case Dishwasher_drying:
        {
            switch (id) {
                ...
                case Null_id:
                {
                    ...
                    if(isDried(me))
                        {
                            NOTIFY_NULL_TRANSITION_STARTED(me, Dishwasher, "8");
                            Dishwasher_on_exit(me);
                            {
                                /*#[ transition 8 */
                                me->cycles++;
...
static void mode_entDef(Dishwasher* const me) {
    ...
    NOTIFY_TRANSITION_STARTED(me, Dishwasher, "3");
    ...
    NOTIFY_TRANSITION_TERMINATED(me, Dishwasher, "3");
}
