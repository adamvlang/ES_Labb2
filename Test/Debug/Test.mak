...
Dishwasher.obj : Dishwasher.c Dishwasher.h    Default.h 
	$(CREATE_OBJ_DIR)
	$(CC) $(ConfigurationCPPCompileSwitches)  /Fo"Dishwasher.obj" "Dishwasher.c" 



Default.obj : Default.c Default.h    Dishwasher.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist Dishwasher.obj erase Dishwasher.obj
